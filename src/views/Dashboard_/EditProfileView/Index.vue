        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          ...
          <div class="col-span-full">
            ...
            <label
              ...
              role="button"
              :style="
                user.cover_photo || perviewCoverPhotoUrl
                  ? `background-image: url(${perviewCoverPhotoUrl ?? user.cover_photo});
...
const handleDeleteAccount = async () => {
  ...
  const confirmed = await deleteConfirmationModal.value.showModal(
    'Delete Account',
